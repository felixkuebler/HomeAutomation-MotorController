...
String generateGeneralSettings(wifi_obj wifi_info)
{
  ...
  page +="<div id=\"general\">";
    ...
    page +="<div>";
      ...
      page +="<form class='update-form' method='POST' action='/update' enctype='multipart/form-data'>";
        page +="<input class='file-input' type='file' name='update'>";
        page +="<input class='btn-input' type='submit' value='Update'>";
      page +="</form>";
    page +="</div>";
  page +="</div>";
...
String generateMQTTSettings(wifi_obj wifi_info, motor_obj motor_info)
{
  ...
  page += "<div class=\"hidden\" id=\"mqtt\">";
    ...
    page += "<div>";
      ...
      page += "<br>";
      page += "<div>";
        page += "<button class=\"btn-input btn-commands\" onclick=\"calibrateMotor()\">Motor Calibration</button>";      
      page += "</div>";
    page += "</div>";  
  page += "</div>";
...
String generateCSS()
{
  ...
  css += "<style>";
    ...
    css += ".file-input {width:20vw; height:4vh; margin:0; padding:0; font-family:Verdana; font-weight:100; font-size:2vh; accept=\"*.ino.bin\"}";
    css += ".btn-input {width:20vw; height:4vh; margin:0; padding:0; font-family:Verdana; font-weight:100; font-size:2vh}";
